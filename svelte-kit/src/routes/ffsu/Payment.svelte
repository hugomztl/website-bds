...
<div class="border-none">
	<h2 class="font-bold text-4xl">Formulaire de paiement</h2>
	<Separator class="my-4" />
	<span class="text-muted-foreground">{current === 1 ?"1 - Informations de base": (current === 2 ? "2 - Informations complémentaires" : (current === 3 ? "3 - Informations sportives" : "4 - Finalisation"))}</span>
				 ...
				 >
				  <!-- FIXME: j'arrive pas a faire fonctionner le composant calendar 🦧​​ (https://www.shadcn-svelte.com/docs/components/calendar) -->
					...
					<div class="flex w-full max-w-sm flex-col gap-1.5">
						...
						<span class="text-red-500 text-sm">{$errors.dpt_naissance}</span>
						{/if}
						...
						<Popover.Content class="p-0">
							...
							<Command.Group>
								...
								<Command.Item
									value={dpt.label}
									onSelect={(currentValue) => {
									selectedDepartement = departements.find(d => d.label === currentValue)?.label || '';
									$_form.dpt_naissance = selectedDepartement;
									closeAndFocusTrigger(ids.trigger);
									}}
								>
									<span class="flex items-center mr-2 h-4 w-4 {selectedDepartement === dpt.label ? '' : 'text-transparent'}">
										<Check class="self-center" />
									</span>
									{dpt.label}
								</Command.Item>
					...
					<Select.Root bind:value={$_form.sport} name="sport">
						...
						<Select.Content>
							...
							<Select.Group>
								...
								<Select.Item value="Athlétisme - Courses hors stade">Athlétisme - Courses hors stade</Select.Item>
								<Select.Item value="Aviron (en ligne,longue distance, de mer, indoor)">Aviron (en ligne,longue distance, de mer, indoor)</Select.Item>
								...
								<Select.Item value="Boxe éducative Assaut">Boxe éducative Assaut</Select.Item>
								<Select.Item value="Boxe(s) Combat, plein contact (Anglaise, Kick Boxing K1 rules, Savate BF)">Boxe(s) Combat, plein contact (Anglaise, Kick Boxing K1 rules, Savate BF)</Select.Item>
								...
								<Select.Item value="Course d'orientation">Course d'orientation</Select.Item>
								<Select.Item value="Cyclisme - VTT - BMX">Cyclisme - VTT - BMX</Select.Item>
								<Select.Item value="Danse (toutes formes)">Danse (toutes formes)</Select.Item>
								...
								<Select.Item value="Gymnastiques : Artistique, GR, Team Gym, Trampoline, Parkour Gym">Gymnastiques : Artistique, GR, Team Gym, Trampoline, Parkour Gym</Select.Item>
								<Select.Item value="Haltérophilie - Musculation">Haltérophilie - Musculation</Select.Item>
								<Select.Item value="Handball - Beach Handball">Handball - Beach Handball</Select.Item>
								<Select.Item value="Hockey">Hockey</Select.Item>
								<Select.Item value="Judo - Ju-Jitsu - Ne Waza">Judo - Ju-Jitsu - Ne Waza</Select.Item>
								<Select.Item value="Karaté">Karaté</Select.Item>
								<Select.Item value="Karting">Karting</Select.Item>
								<Select.Item value="Kick Boxing - Muay-Thaï Light et Pré combat">Kick Boxing - Muay-Thaï Light et Pré combat</Select.Item>
								<Select.Item value="Lutte - Sambo sportif - Beach Wrestling">Lutte - Sambo sportif - Beach Wrestling</Select.Item>
								<Select.Item value="Nage avec palmes">Nage avec palmes</Select.Item>
								<Select.Item value="Natation - Natation synchronisée - Natation en eau libre">Natation - Natation synchronisée - Natation en eau libre</Select.Item>
								<Select.Item value="Pancrace assaut">Pancrace assaut</Select.Item>
								<Select.Item value="Patinage artistique et de vitesse">Patinage artistique et de vitesse</Select.Item>
								...
								<Select.Item value="Rugby(s) (XV, X, 7, XIII)">Rugby(s) (XV, X, 7, XIII)</Select.Item>
								<Select.Item value="Sauvetage sportif">Sauvetage sportif</Select.Item>
								<Select.Item value="Savate Boxe Française en assaut">Savate Boxe Française en assaut</Select.Item>
								<Select.Item value="Skateboard - Trottinette">Skateboard - Trottinette</Select.Item>
								<Select.Item value="Ski - Snowboard (toutes formes)">Ski - Snowboard (toutes formes)</Select.Item>
								<Select.Item value="Squash">Squash</Select.Item>
								<Select.Item value="Surf - Stand Up Paddle">Surf - Stand Up Paddle</Select.Item>
								<Select.Item value="Taekwondo">Taekwondo</Select.Item>
								<Select.Item value="Tennis - Padel - Beach Tennis">Tennis - Padel - Beach Tennis</Select.Item>
								...
								<Select.Item value="Triathlon et Disciplines enchainées : [Bike & Run, Duathlon, Raids multisports, Swimrun]">Triathlon et Disciplines enchainées : [Bike & Run, Duathlon, Raids multisports, Swimrun]</Select.Item>
								<Select.Item value="Ultimate - Beach Ultimate">Ultimate - Beach Ultimate</Select.Item>
								<Select.Item value="Voile - Kite Surf">Voile - Kite Surf</Select.Item>
								<Select.Item value="Volley - Beach Volley">Volley - Beach Volley</Select.Item>
